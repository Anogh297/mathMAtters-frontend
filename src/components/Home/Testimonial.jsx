...
export default function Testimonial() {
    return (
        <>
            ...
            <div className="max-w-7xl mb-24 mx-auto font-mons space-x-10 flex justify-between items-center">
                    ...
                    <div className="relative p-6">
                        <figure className="relative z-10">
                            <blockquote className="p-6 text-lg leading-relaxed">
                                <p>
                                Math Matters has revolutionized how I approach mathematics. The sleek interface, engaging contests, and accessible resources make learning both effective and enjoyable.
                                </p>
                            </blockquote>
                            <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-emerald-500">
                                ...
                                <div className="flex items-center gap-4 pt-4 text-sm text-emerald-500">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <span className="font-bold uppercase">You Know Who</span>
                                        <cite className="not-italic">
                                            <a href="http://www.microsoft.com">CEO, youknowwho.academy</a>
                                        </cite>
                                    </div>
                                </div>
                            </figcaption>
                ...
                <div class="overflow-hidden bg-white rounded shadow-2xl text-slate-500 shadow-slate-200">
                    <div class="relative p-6">
                        <figure class="relative z-10">
                            <blockquote class="p-6 text-lg leading-relaxed">
                                <p>   Math Matters has revolutionized how I approach mathematics. The sleek interface, engaging contests, and accessible resources make learning both effective and enjoyable.</p>
                            </blockquote>
                            <figcaption class="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-emerald-500">
                                <span class="flex gap-1 text-amber-400" role="img" aria-label="Rating: 3 out of 5 stars">
                                    <span aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                                    ...
                                    <span aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
                                    </svg>
                                    </span>
                                </span>
                                <div class="flex items-center gap-4 pt-4 text-sm text-emerald-500">
